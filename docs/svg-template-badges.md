...
| 大动态卡片 SVG | 大尺寸动态卡片，展示头像、群名、建群时间、人数、简介、前三个标签和群号。 | `https://raw.githubusercontent.com/clown145/qq-group-badge/main/examples/group-dynamic-card-template.svg` |
